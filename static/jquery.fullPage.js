...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        /* Algee — added wraping div fp-controlArrows */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="fp-controlArrows"><div class="' + SLIDES_ARROW_PREV + '"></div><div class="' + SLIDES_ARROW_NEXT + '"></div></div>');
